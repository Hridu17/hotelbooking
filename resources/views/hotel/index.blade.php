...
<head>
    ...
    <meta name="description" content="Book your stay at the best hotel." />
...
<body class="index-page">
    ...
    <footer id="footer" class="footer dark-background">
            ...
            <div class="row gy-3">
                ...
                <div class="col-lg-3 col-md-6 d-flex">
                    ...
                    <div>
                        <h4>Contact</h4>
                        <p>
                            <strong>Phone:</strong> <span>+977 9800000000</span><br />
                            <strong>Email:</strong> <span>hotelAHP1@gmail.com</span><br />
                        </p>
                    </div>
                </div>
        ...
        <div class="container copyright text-center mt-4">
            <p>
                © <span>Copyright</span>
                <strong class="px-1 sitename">AHP Hotel</strong>
            ...
            <div class="credits">
                ...
                Designed by <a href="https://bootstrapmade.com/">AHP Hotel</a>
            </div>
        </div>
    </footer>
