    ...
    <section id="book-a-table" class="book-a-table section">
        ...
        <div class="container">
            <div class="row g-0" data-aos="fade-up" data-aos-delay="100">
                <div class="col-lg-4 reservation-img" style="background-image: url(public/assets/image/lobby.avif)">
                </div>
                    ...
                    <div class="swiper-slide">
                        <a class="glightbox" data-gallery="images-gallery"
                            href="public/assets/image/gallery/enjoy1.avif"><img
                                src="public/assets/image/gallery/enjoy1.avif" class="img-fluid" alt="" /></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="glightbox" data-gallery="images-gallery"
                            href="public/assets/image/gallery/enjoy2.jpg"><img
                                src="apublic/assets/image/gallery/enjoy2.jpg" class="img-fluid" alt="" /></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="glightbox" data-gallery="images-gallery"
                            href="public/assets/image/gallery/enjoy3.jpg"><img
                                src="public/assets/image/gallery/enjoy3.jpg" class="img-fluid" alt="" /></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="glightbox" data-gallery="images-gallery"
                            href="public/assets/image/gallery/enjoy4.webp"><img
                                src="public/assets/image/gallery/enjoy4.webp" class="img-fluid" alt="" /></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="glightbox" data-gallery="images-gallery"
                            href="public/assets/image/gallery/enjoy5.jpg"><img
                                src="public/assets/image/gallery/enjoy5.jpg" class="img-fluid" alt="" /></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="glightbox" data-gallery="images-gallery"
                            href="public/assets/image/gallery/enjoy6.jpg"><img
                                src="public/assets/image/gallery/enjoy6.jpg" class="img-fluid" alt="" /></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="glightbox" data-gallery="images-gallery"
                            href="public/assets/image/gallery/enjoy7.jpg"><img
                                src="public/assets/image/gallery/enjoy7.jpg" class="img-fluid" alt="" /></a>
                    </div>
                    <div class="swiper-slide">
                        <a class="glightbox" data-gallery="images-gallery"
                            href="public/assets/image/gallery/enjoy8.webp"><img
                                src="public/assets/image/gallery/enjoy8.webp" class="img-fluid" alt="" /></a>
                    </div>
                </div>
                <div class="swiper-pagination"></div>
            </div>
